    ...
    public void setDeviceDetails_shouldWork() {
        getInstrumentation().runOnMainSync(new Runnable() {
            ...
            public void run() {
                ...
                assertThat(underTest.mDeviceDetails, containsString("model: 'Nexus 5X'"));
                assertThat(underTest.mDeviceDetails, containsString("sdk: '27'"));
                assertThat(underTest.mDeviceDetails, containsString("identifier: 'aad6b1e07b3ec579'"));
                assertThat(underTest.mDeviceDetails, containsString("location:{longitude: '0.0', latitude: '0.0', accuracy: '0.0'}"));
                assertThat(underTest.mDeviceDetails, containsString("wifiMACaddress: 'unknown'"));
