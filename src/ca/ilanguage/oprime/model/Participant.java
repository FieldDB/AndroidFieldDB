...
public class Participant {
  ...
  public Participant() {
    ...
    this.code = this.experimenterCode + counter;
  ...
  public Participant(String code, String experimenterCode, String firstname, String lastname, Date birthdate,
      int gender, long dateTested, String details, ArrayList<String> languages) {
    this.code = code;
  ...
  public void setBirthdate(String birthdate) {
    ...
    try {
      GregorianCalendar c = new GregorianCalendar(Integer.parseInt(date[0]), Integer.parseInt(date[1]),
  ...
  /**
   * Accepts a string in english or french and attempts to guess the gender
   * MALE/M/Homme/homme = Male, Female/F/Femme = Female
   * 
   * @param gender
   */
  ...
  public void setLanguages(String languages) {
    ...
    this.extractLanguageCodes(this.languages);
  }
  ...
  public String toCSVPrivateString() {
    return this.code + "," + this.firstname + "," + this.lastname + "," + this.birthdate + "," + this.gender + ","
        + new Date(this.dateTested).toString() + "," + this.experimenterCode + "," + this.details + ": " + this.status
        + "," + this.languageCodes;
  }

  public String toCSVPublicString() {
    return this.code + "," + new Date(this.dateTested).toString() + "," + this.experimenterCode + "," + this.status
        + "," + this.languageCodes;
  }
