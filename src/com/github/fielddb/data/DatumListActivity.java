...
public class DatumListActivity extends FragmentActivity implements DatumListFragment.Callbacks {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    if (findViewById(R.id.datum_detail_container) != null) {
      ...
      ((DatumListFragment) getSupportFragmentManager().findFragmentById(R.id.datum_list)).setActivateOnItemClick(true);
    }
  ...
  public void onItemSelected(String id) {
    if (mTwoPane) {
      ...
      getSupportFragmentManager().beginTransaction().replace(R.id.datum_detail_container, fragment).commit();
