...
public abstract class FieldDBTable {
  ...
  public static String generateCreateTableSQLStatement(String TABLE_NAME) throws Exception {
    if (columns == null) {
      throw new Exception("Columns have not been defined, please define the columns first.");
    }

    String preamble = "create table " + TABLE_NAME + "(" + COLUMN_ANDROID_ID + " INTEGER primary key AUTOINCREMENT, ";
    String postamble = ");";
  ...
  public static String generateUpgradeTableSQLStatement(String TABLE_NAME, ArrayList<String> previousColumns)
      throws Exception {
    if (previousColumns == null) {
      throw new Exception("Previous columns has not been defined, please define the previous columns first.");
    }
